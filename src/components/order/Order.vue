               ...
               <ul class="cf">
                  <li>
                      <div class="li_wrap cf">
                          <div class="img_left dis"><img src="./pict/checked.png" height="40" width="40"></div>
                  ...
                  <li>
                    <div class="li_wrap cf">
                        <div class="img_left dis"><img src="./pict/checked.png" height="40" width="40"></div>
                        <div class="one"><img src="./pict/equipment.png" height="86" width="86"></div>
                        <div class="two">
                          <h3 >智能设备</h3>
                          <p>电脑/网络维修，网络调试电脑系统重装等</p>
                        </div>  
                    </div>
                  </li>
              </ul>
